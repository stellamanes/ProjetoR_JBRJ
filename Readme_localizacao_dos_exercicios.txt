Exercicios para a avaliacao do curso de Projetos de análise de dados usando R. (JBRJ)

Os exercicios estão localizados nos seguintes scripts:

-o exercício de formatação de dados
...
-o exercicío de análise exploratória dos dados 
Script Analise_exploratoria_dados.R contem o exercicio 6, no topico "Exercicios"

-07 da aula de gráficos 
